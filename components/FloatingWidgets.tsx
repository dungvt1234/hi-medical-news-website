...
/**
 * Floating widgets cố định góc dưới bên phải:
    ...
    <div className="fixed bottom-6 right-4 z-50 flex flex-col items-end gap-3 sm:right-6">
      ...
      >
        ...
        >
          ...
          <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-lg bg-brand-800 px-3 py-1.5 text-xs font-semibold text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
            Chat Zalo
          </span>
        </a>
        ...
        <a
          ...
          className="group relative flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#00b2ff] to-[#006aff] text-white shadow-lg transition-transform hover:scale-110"
        >
          <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current" aria-hidden>
        ...
        <a
          ...
          className="group relative flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-gold to-gold-dark text-white shadow-lg transition-transform hover:scale-110"
        >
      ...
      <button
        ...
        aria-expanded={open}
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-brand-800 text-white shadow-card-lg transition-all hover:scale-105"
      >
        ...
        {!open && (
          <span
            aria-hidden
            className="absolute inset-0 rounded-full bg-brand-500/60 animate-pulse-ring"
          />
        )}
      </button>
    </div>
