...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { name: 'CẤP ẨM ĐA TẦNG', en: 'Deep Cleansing', desc: 'WHITENING COMPLEX' },
      ...
      { name: 'TÁI SINH DA HÀN QUỐC', en: 'Luxury Mask', desc: 'LUXURY GOLD THERAPY' },
      { name: 'NANO NGẬM TRẮNG HOÀN HẢO', en: 'Body Care', desc: 'Dưỡng trắng bật tone ngay sau' },
