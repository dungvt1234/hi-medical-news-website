...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { name: 'Dưỡng ẩm & phục hồi', en: 'Hydration Therapy', desc: 'Da khô, da thiếu ẩm, da nhạy cảm — phục hồi lớp bảo vệ tự nhiên của da.' },
      { name: 'Đắp mặt nạ dưỡng da', en: 'Luxury Mask', desc: 'Collagen, vàng 24K, thảo dược — nuôi dưỡng da sáng khỏe.' },
