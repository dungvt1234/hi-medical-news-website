...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    subs: [
      { name: 'CHĂM SÓC DA CHUẨN HÀN', desc: 'Căng bóng mướt mịn' },
      { name: 'CẤP ẨM ĐA TẦNG', desc: 'WHITENING COMPLEX' },
      { name: 'SUPER DETOX SKIN THẢI ĐỘC', desc: 'Cho da mụn, da dầu, lỗ chân lông to — làm sạch tận sâu.' },
      { name: 'HỒI SINH DA', desc: 'NHIỄM ĐỘC - DỊ ỨNG' },
      { name: 'TÁI SINH DA HÀN QUỐC', desc: 'LUXURY GOLD THERAPY' },
      { name: 'NANO NGẬM TRẮNG HOÀN HẢO', desc: 'Dưỡng trắng bật tone ngay sau' },
